...
class CharacterEditorState extends MusicBeatState
{
	...
	function reloadBGs() {
		...
		if(onPixelBG) {
			...
			var bg:BGSprite = new BGSprite('gameplaybg/city', -600 + OFFSET_X - playerXDifference, -300, 0.9, 0.9);
			bgLayer.add(bg);

			var stageFront:BGSprite = new BGSprite('gameplaybg/ground', -600 + OFFSET_X - playerXDifference, -300, 0.9, 0.9);
