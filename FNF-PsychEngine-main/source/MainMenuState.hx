	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (FlxG.keys.justPressed.D)
				{var sound:FlxSound = new FlxSound().loadEmbedded(Paths.sound('vineboom'));
				sound.play();
				if (FlxG.sound.music.volume - 0.2 > 0){
				FlxG.sound.music.volume -= 0.2;
				sound.onComplete = function(){sound.destroy(); FlxG.sound.music.volume += 0.2;};}}
			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					...
					menuItems.forEach(function(spr:FlxSprite)
					{
						...
						{
							FlxTween.tween(binjaiman, {y: 900}, 1.3, {ease: FlxEase.expoIn});
							FlxTween.tween(blackBG, {y: 900}, 1.4, {ease: FlxEase.expoIn});
							FlxTween.tween(binjaiBG, {y: 900}, 1.2, {ease: FlxEase.expoIn});
